    ...
    <Box {...sectionWrapper} as="section" id="process_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading
            {...secTitle}
            content="From Development to Deployment"
          />
          {/* <Text
            {...secDescription}
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            ...
            />
            <Text
              content="I believe that we succeed when our clients succeed."
              {...learningSubTitle}
            />
            <Text
              {...learningDescription}
              content="I’m Kamran Nazir, a Pakistan born Software Developer currently looking for remote opportunities. Over the 3+ years of my career, my portfolio includes from front end development with React and React Native, backend with Nodejs, Python and Cloud deployments using AWS services."
            />
            <Text
              {...learningDescription}
              content="While at IP Global over the last few years, I've worked on web and mobile projects for telecom solutions."
            />
            <Box {...buttonWrapper}>
              <Text content="Start Your Project ?" {...buttonLabelStyle} />
              <ButtonWrapper>
                <Button
                  title="kamrannazir692@gmail.com"
