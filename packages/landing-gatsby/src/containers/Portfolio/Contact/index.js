...
import Author from 'common/src/assets/image/portfolio/me.jpeg';
    ...
    <Box {...sectionWrapper} as="section" id="contact">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          ...
          <Text
            {...secDescription}
            content="If you have a website or mobile app idea in mind or you need some advice about product design, feel free to contact me."
          />
        </Box>
        <Box {...replyWrapper}>
          <ActiveStatus>
